...
public class UserExcel {
	...
	public UserExcel (File f, String inst) {
...
//							System.out.println(cellValue.substring(6,8));
	...
	public static void main(String[] args) {
		try (BufferedWriter writer = 
			...
			String inst = "ECB_SB";
			UserExcel uExcel = new UserExcel(new File("C:\\Users\\PieterDV\\Downloads\\usersECB\\usersECB.xlsx"),inst);
...
/*
System.out.println(u.getPrimaryId());
System.out.println(u.getLastName());
System.out.println(u.getBirthDate().toString());
*/
//changing the domains of all user emails from @ecb.int to @ecb.europa.eu.
//for (Email em: u.getContactInfo().getEmails().getEmail()) {
//	writer.write(em.getEmailAddress().toString());
//	writer.newLine();
//	//System.out.println(em.getEmailAddress().toString());
//	String prevemail = em.getEmailAddress().toString();
//	em.setEmailAddress(prevemail.replaceAll("ecb.int","ecb.europa.eu"));
//}
//for (Email em: u.getContactInfo().getEmails().getEmail() ) {
//	writer.write(em.getEmailAddress().toString());
//	writer.newLine();
